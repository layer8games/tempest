...
///	\param w is the value for w.
        TEMPEST_API Point2(real x, real y);
...
///	\param v is the Point2 to copy. 
        ...
        TEMPEST_API Point2(const Vector3& v);

        /// Convert a Vector4 into a Point2
        TEMPEST_API Point2(const Vector4& v);
...
//
//==========================================================================================================================
///	Returns the raw data for the Point2.
...
//
//==========================================================================================================================
///	Allows you to index into the Point2 to read the value.
...
///	Allows you to index into the Point2 to change the value.
