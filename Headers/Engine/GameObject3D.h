...
namespace Tempest
{
    /// The GameObject3D may be the backbone of Tempest. This is the basic object that will exist in the game. It is the root of 
...
//
//==========================================================================================================================
        /// Abstract function. This update is called one per frame, if the object is registered with the GameObject3DManager and is
        /// Update Active.
        ...
        /// Handle an event that is passed to this object. This behavior is to be defined by each GameObject3D that is made. 
...
//==========================================================================================================================
//===== All Active =====
        /// Get the active state of the GameObject3D. Returns true if is active update and active render		
...
//===== ID =====
        /// Returns the ID for the GameObject3D.		
...
//===== Position =====
        ...
        /// Set the x, y and z values of the GameObject3D in world space. The bounding box center is updated. 
        ...
        /// Set just the x value of the GameObject3D in world space. Bounding box center is updated.
        /// \param xval is the new x offset.
        ...
        /// Set just the y value of the GameObject3D in world space. Bounding box center is updated.
        /// \param yVal is the new y offset.		
        ...
        /// Set just the z value of the GameObject3D in world space. Bounding box center is updated.
        /// \param zVal is the new z offset.
        ...
        /// Set the Position of the GameObject3D scaled by a factor. Vector4::AddScaledVector is called. Bounding Box is updated. 
        ...
        /// Set the Position of the GameObject3D scaled by a factor. Vector3::AddScaledVector is called. Bounding Box is updated. 
        /// \param pos is the new position for the object.
        /// \param scale is the factor that the pos is scaled by.
...
//===== Scale =====
        /// Return the current scale factor for the GameObject3D.		
        inline const TM::Vector3& GetScale(void) const
        {
            return _scale;
        }

        /// Sets a new scale factor for the GameObject3D. Bounding Box is updated.
...
//===== Orientation =====
        /// Returns the current orientation of the GameObject3D		
        inline const TM::Quaternion& GetOrientation(void) const
        {
            return _orientation;
        }

        /// Set a new orientation for the GameObject3D.
        ...
        /// Set the orientation of the GameObject3D with an Euler Angle. The Vector3 is treated as 
        ...
        /// Set the orientation of the GameObject3D with an Euler Angle.
        /// \param yaw
        /// \param pitch
        /// \param roll
...
//===== Color =====		
        /// Change the color of the GameObject3D.
        ...
        /// Change the color of the GameObject3D without having to create a Color object. Alpha is ommited.
        ...
        /// Return the color of the GameObject3D		
...
//===== AABB Bounding Volume =====
        /// Helper wrapper for AABB::TestCollission. This checks if the Bounding Box of another GameObject3D is overlapping this GameObject3D.
        /// Returns true if the bounding boxes overlap.
        /// \param other is the GameObject3D to test against.
        inline bool OverlapCheck(const shared_ptr<GameObject3D> other)
        {
            return _boundingBox.TestCollision(other->GetBounding());
        }

        /// Return the bounding boxe of this GameObject3D.		
...
//===== Texture =====
        /// Change the texture of the GameObject3D. 
        /// \param texture is the new texture for the GameObject3D.
        ...
        /// Return the current texture pointer for the GameObject3D.		
        inline p_Texture GetTexture(void) const
        {
            return _texture;
        }

        /// Helper wrapper to call Texture::Bind on the texture that is saved on this GameObject3D.		
...
//===== Shader =====
        /// Returns the current shader for this GameObject3D.		
        inline const p_Shader GetShader(void) const
        {
            return _shader;
        }

        /// Change the shader for this GameObject3D.		
    ...
    protected:
        ...
        /// Default behavior that should be considered when calling Update on an GameObject3D. This calls UpdateInternals.
