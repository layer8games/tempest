...
//
//==========================================================================================================================	
	RenderedText::RenderedText(void) : _pos(0.0f),
									   _text(), 
									   _font(), 
									   _characterList(), 
									   _totalWidth(0), 
	...
	RenderedText::RenderedText(Font& font) : _text(), _font(font), _characterList(), _totalWidth(0), _totalHeight(0), _center(0.0f)
	{  }

	RenderedText::RenderedText(string text, Font& font) : _text(text), _font(font), _characterList(), _totalWidth(0), _totalHeight(0), _center(0.0f)
	{
		AddText(_text);
	}
