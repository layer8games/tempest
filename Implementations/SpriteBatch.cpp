...
//
//=======================================================================================================
	SpriteBatch::SpriteBatch(void): _maxBatchSize(1000), 
							  		_currentBatchSize(0),
							  		_vertices(0),
							  		_colors(0),
							  		_dimensions(0),
...
//ShutDown
//=======================================================================================================
	/*void SpriteBatch::ShutDown(void) {
		delete _instance;
...
//==========================================================================================================================
	void SpriteBatch::AddToBatch(Model& m)
	{
