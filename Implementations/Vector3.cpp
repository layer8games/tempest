...
//
//==========================================================================================================================
	Vector3::Vector3(void) : _x(0.0f), _y(0.0f), _z(0.0f), _w(1.0f)
	{  }

	Vector3::Vector3(F32 val) : _x(val), _y(val), _z(val), _w(1.0f)
	{  }

	Vector3::Vector3(F32 x, F32 y) : _x(x), _y(y), _z(0.0f), _w(1.0f)
	{  }
	...
	Vector3::Vector3(const Vector2& V) : _x(V.GetX()), _y(V.GetY()), _z(0.0f), _w(1.0f)
	{  }
