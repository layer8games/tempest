...
//Instance
//=======================================================================================================
shared_ptr<GameWindow> GameWindow::_instance = NULL;
int GameWindow::_totalWidth = 0;
int GameWindow::_totalHeight = 0;

shared_ptr<GameWindow> GameWindow::Instance(void) 
{
    if(_instance == NULL) 
    { 
        _instance = shared_ptr<GameWindow>(new GameWindow());
    }
    return _instance;
}
...
void GameWindow::Init(S32 width, S32 height, string wndName, bool isFullScreen) 
{
    ...
    if(!glfwInit())
    {
    	ErrorManager::Instance()->SetError(OPENGL, "Failed to init GLFW. GameWindow.");
    }
    ...
    if(_window == NULL)
    {
    	ErrorManager::Instance()->SetError(OPENGL, "Failed to create GLFW window. GameWindow.");
    }
    ...
    if(glewInit() != GLEW_OK)
    {
    	ErrorManager::Instance()->SetError(OPENGL, "Failed to init glew. GameWindow.");
    }
...
//BufferSwap
//=======================================================================================================
void GameWindow::BufferSwap(void)
{ 
    glfwSwapBuffers(_window);
    glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
}

Keys GameWindow::ConvertKeyCodes(int key)
{
    switch(key)
    {
        case GLFW_KEY_A:
...
void GameWindow::DisplayFPS(void)
{
...
void GameWindow::ToggleWireFrame(void)
{
...
void GameWindow::ResetMouseCursor(void)
{
    glfwSetCursorPos(_window, _totalWidth / 2.0f, _totalHeight / 2.0f);
}

void GameWindow::EnableMouseCursor(void)
{
    glfwSetInputMode(_window, GLFW_CURSOR, GLFW_CURSOR_NORMAL);
}

void GameWindow::DisableMouseCursor(void)
{
    glfwSetInputMode(_window, GLFW_CURSOR, GLFW_CURSOR_DISABLED);
}

void GameWindow::HideMouseCursor(void)
{
...
//OnKey
//=======================================================================================================    
void GameWindow::OnKey(GLFWwindow* window, int key, int scancode, int action, int mods)
{
...
//OnResize
//==========================================================================================================================
void GameWindow::OnResize(GLFWwindow* window, int width, int height)
{
    _totalWidth = width;
    _totalHeight = height;
    glViewport(0, 0, _totalWidth, _totalHeight);
...
//OnMouseMove
//==========================================================================================================================
void GameWindow::OnMouseClick(GLFWwindow* window, int button, int action, int mods)
{   
