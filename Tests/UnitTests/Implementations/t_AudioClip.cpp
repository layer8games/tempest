...
BOOST_AUTO_TEST_CASE(AudioClipConstructor)
{
	...
	BOOST_CHECK_EQUAL(clip.GetChannels(), 0);
	BOOST_CHECK_EQUAL(clip.GetSampleRate(), 0);
	BOOST_CHECK_EQUAL(clip.GetBPS(), 0);
	BOOST_CHECK_EQUAL(clip.GetSize(), 0);
	BOOST_CHECK_EQUAL(clip.GetALFormat(), 0);
}
